        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-12">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/10 text-white font-semibold rounded-lg transition-colors"
              >
                <Github size={20} />
                View on GitHub
              </a>
          ...
          <div className="grid lg:grid-cols-[1fr_300px] gap-8">
            ...
            <div className="space-y-8">
              ...
              {/* Legend */}
              <div className="mt-16 bg-brand-navy-light border border-white/10 rounded-xl p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
                    ...
                    <p className="text-sm text-gray-400 mt-2">New features</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
                    ...
                    <p className="text-sm text-gray-400 mt-2">Changes</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
                    ...
                    <p className="text-sm text-gray-400 mt-2">Soon removed</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
                    ...
                    <p className="text-sm text-gray-400 mt-2">Removed</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
                    ...
                    <p className="text-sm text-gray-400 mt-2">Bug fixes</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
