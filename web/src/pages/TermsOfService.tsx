        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              By accessing and using the Daily Dose Slack bot (the "Service"),
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              ...
              materials (information or software) on Daily Dose for personal,
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              The materials on Daily Dose are provided on an 'as is' basis.
              Daily Dose makes no warranties, expressed or implied, and hereby
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              In no event shall Daily Dose or its suppliers be liable for any
              damages (including, without limitation, damages for loss of data
              or profit, or due to business interruption) arising out of the use
              or inability to use the materials on Daily Dose, even if we or our
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              ...
              typographical, or photographic errors. Daily Dose does not warrant
              that any of the materials on its Service are accurate, complete,
              or current. Daily Dose may make changes to the materials contained
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              Daily Dose has not reviewed all of the sites linked to its Service
              and is not responsible for the contents of any such linked site.
              The inclusion of any link does not imply endorsement by Daily Dose
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              Daily Dose may revise these terms of service for its Service at
          ...
          <section className="mb-8">
            ...
            <p className="text-text-secondary mb-4">
              ...
              accordance with the laws of the jurisdiction in which Daily Dose
