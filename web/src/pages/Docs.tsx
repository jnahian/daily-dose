...
export const meta = () => {
  return [
    { title: "Documentation - Daily Dose | Slack Bot Setup Guide" },
    {
      name: "description",
      content:
        "Daily Dose Documentation - Complete guide for setting up and using the Slack standup bot. Commands, setup instructions, and troubleshooting.",
    },
    {
      name: "keywords",
      content:
        "daily dose docs, slack bot documentation, standup automation, team management guide",
    },
    { name: "author", content: "Daily Dose" },
    { property: "og:type", content: "website" },
    { property: "og:url", content: "https://dd.jnahian.me/docs" },
    {
      property: "og:title",
      content: "Daily Dose Documentation - Complete Setup Guide",
    },
    {
      property: "og:description",
      content:
        "Comprehensive documentation for Daily Dose Slack bot including commands, setup instructions, and troubleshooting.",
    },
    { property: "og:image", content: "/logo.png" },
    { property: "twitter:card", content: "summary_large_image" },
    { property: "twitter:url", content: "https://dd.jnahian.me/docs" },
    {
            ...
            <main className="flex-1 min-w-0 py-6 md:py-12">
              ...
              <div className="mb-12">
                ...
                <p className="text-xl text-text-secondary">
                  Everything you need to know about using Daily Dose for your
                  team's standups.
                </p>
              </div>
