...
const Step = ({ number, title, description, isLast }: StepProps) => (
  <div className="flex gap-6 relative">
    ...
    <div className="shrink-0">
      <div className="w-12 h-12 rounded-full bg-bg-surface border border-brand-cyan/30 flex items-center justify-center text-brand-cyan font-bold text-xl shadow-[0_0_15px_rgba(0,207,255,0.2)]">
        {number}
      </div>
    </div>
    <div className="pb-16">
