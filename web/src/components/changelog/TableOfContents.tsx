...
export const TableOfContents = ({ versions, activeVersion, setActiveVersion }: TableOfContentsProps) => {
    ...
    return (
        <div className="sticky top-24 bg-brand-navy-light border border-white/10 rounded-xl p-6 h-fit">
            ...
            `}
                    >
                        <ChevronRight size={14} className={activeVersion === version.version ? 'opacity-100' : 'opacity-0'} />
